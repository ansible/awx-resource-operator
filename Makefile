...
# ENGINE defines the container engine to be used. Default value is docker, but you may use podman as well. Notice
...
# ansible.com/awx-resource-operator-bundle:$VERSION and ansible.com/awx-resource-operator-catalog:$VERSION.
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.40.0/ansible-operator_$(OS)_$(ARCH) ;\
